...
export const BUILTIN_FOODS: FoodDatabaseItem[] = [
  // Protein
  { id: 'chicken-breast', name: 'Chicken Breast, cooked', per100g: { calories: 165, protein: 31, carbs: 0, fat: 3.6 }, units: [{ unit: 'breast (medium)', grams: 174 }] },
  { id: 'chicken-thigh', name: 'Chicken Thigh, cooked', per100g: { calories: 209, protein: 26, carbs: 0, fat: 10.9 }, units: [] },
  { id: 'ground-beef-85', name: 'Ground Beef 85/15, cooked', per100g: { calories: 250, protein: 26, carbs: 0, fat: 17 }, units: [] },
  { id: 'beef-steak', name: 'Beef Steak (sirloin), cooked', per100g: { calories: 183, protein: 29, carbs: 0, fat: 7 }, units: [] },
  ...
  { id: 'pork-chop', name: 'Pork Chop, cooked', per100g: { calories: 231, protein: 25, carbs: 0, fat: 14 }, units: [] },
  { id: 'turkey-breast', name: 'Turkey Breast, cooked', per100g: { calories: 135, protein: 30, carbs: 0, fat: 1 }, units: [] },
